...
class AutoResolverService {
  ...
  async resolve(
    ...
    return this.resolveInternal(slugs, context, tenantId, overrides);
  }

  /**
   * Core resolve logic: builds dependency graph from the given slugs only.
   * Only auto-resolves params with context_var set (SAP DM entity references).
   */
